...
class FaceDetector:   
    ...
    def plot_boxes(self, results, frame,TouchSayac):  
        ...
        # Z ekseni için point olusturalım 
        ...
        for i in range(n):
            ...
            if row[4] >= 0.7:
                ...
                cv2.putText(frame, self.class_to_label(labels[i])+'    '+  str(KeyPoint) + '    '+ str(round(sayi, 2)),(x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 0.9, bgr, 2)#+ Mesafe + "   "+
    ...
    def __call__(self):                 
        ...
        while True:
            ...
            frame = cv2.resize(frame, (1280, 720))     # video screen size
